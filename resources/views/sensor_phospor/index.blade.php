    ...
    <div class="pagetitle">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Sensor Phospor</li>
            </ol>
        </nav>
    </div>
    ...
    <section class="section">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <h5 class="card-title mb-3 text-dark fw-semibold">
                    <i class="bi bi-graph-up me-2"></i>Sensor Phospor
                </h5>

                <div class="mb-3 d-flex justify-content-start gap-2">
                    <a href="{{ url('/export/phospor') }}" class="btn btn-success">
                        <i class="bi bi-download me-1"></i> Export Data
                    </a>
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalTambah">
                        <i class="bi bi-plus-circle me-1"></i> Tambah Data
                    </button>
                    <button type="button" class="btn btn-primary" id="btn-fetch-phospor">
                        ...
                        <tbody class="text-center">
                            <tr>
                                ...
                                <td class="d-flex justify-content-center gap-1">
                                    ...
                                    <!-- Delete -->
                                    <form action="{{ route('sensor_phospor.destroy', $sensorData['ri']) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus data?')">
                                        @csrf
                                        @method('DELETE')
        ...
        <div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="modalTambahLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form action="{{ route('sensor_phospor.store') }}" method="POST" class="modal-content">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Data Phospor</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label">Nilai Phospor</label>
        ...
        <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEditLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form action="{{ route('sensor_phospor.update', $sensorData['ri']) }}" method="POST" class="modal-content">
                    @csrf
                    @method('PUT')
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Data Phospor</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
        ...
        <div class="modal fade" id="modalView" tabindex="-1" aria-labelledby="modalViewLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Detail Data Phospor</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
        ...
        <div class="alert alert-warning text-center">
            Data sensor Phospor tidak ditemukan.
        </div>
        @endif
    </section>
</main>
