...
class SensorPhosporController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('sensor_phospor.index', [
    ...
    public function export()
    {
        ...
        $filePath = storage_path('app/public/data-phospor.csv');
    ...
    {
        $device = 'phospor'; // Ganti sesuai device
        $url = "https://platform.antares.id:8443/~/antares-cse/antares-id/{$this->appName}/{$device}/la";
